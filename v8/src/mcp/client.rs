        ...
        let result = connection
            .request(
                ...
                json!({
                    ...
                    "capabilities": {},
                    "clientInfo": {"name": "mini-harness-v8", "version": "0.1.0"}
                }),
                &self.limits,
                &self.server_name,
            )
    ...
    async fn request(
        ...
        let request = timeout(limits.request_timeout, async {
            ...
            loop {
                ...
                if let Some(server_method) = object.get("method") {
                    if !server_method.is_string()
                        ...
                        || object.contains_key("error")
                    {
                        return Err(protocol_error(
                            ...
                            "protocol",
                            None,
                            "malformed server request or notification",
                        ));
                    }
