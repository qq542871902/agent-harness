...
/// Persisted canonical state for exactly one V9 coding-agent task.
...
pub struct AgentState {
    ...
    #[serde(default)]
    pub in_flight_tool_call: Option<InFlightToolCall>,
    #[serde(default)]
...
impl AgentState {
    ...
    pub fn with_max_steps(user_prompt: impl Into<String>, max_steps: usize) -> Self {
        Self::with_system_prompt(CODING_AGENT_SYSTEM_PROMPT, user_prompt, max_steps)
    }
